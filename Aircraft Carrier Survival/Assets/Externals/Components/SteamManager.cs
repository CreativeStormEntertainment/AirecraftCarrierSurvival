...
public class SteamManager : MonoBehaviour {
	...
	public uint SteamID => steamID;

	[SerializeField]
	private uint steamID = 420;
	...
	protected virtual void Awake() {
		...
		if(!SteamApps.BIsSubscribedApp((AppId_t)SteamID))
		{
			Debug.LogError("[Steamworks.NET] You don't own this game", this);
			Application.Quit();
		}
