    ...
    public class GPUICrowdManager : GPUInstancerPrefabManager
    {
        ...
        public override void OnEnable()
        {
            ...
            if (Application.isPlaying && animationEvents != null)
            {
                ...
                {
                    if (animationEvent.prototype.animationData.useCrowdAnimator)
        ...
        public override void Update()
        {
            ...
            if (runtimeDataList != null)
            {
                foreach (GPUICrowdRuntimeData runtimeData in runtimeDataList)
                {
                    ...
                    if (crowdPrototype.autoUpdateTransformData || (crowdPrototype.applyRootMotion && !crowdPrototype.animationData.useCrowdAnimator))
                    {
                    ...
                    {
                        if (crowdPrototype.applyRootMotion /*&& calculateRootMotion*/)
                        {
#if UNITY_EDITOR
        ...
        public override void SetRenderersEnabled(GPUInstancerPrefab prefabInstance, bool enabled)
        {
            ...
            else
            {
                ...
                if (skinnedMeshRenderers != null && skinnedMeshRenderers.Length > 0)
                {
                    ...
                    {
                        if (GPUInstancerUtility.IsInLayer(layerMask, skinnedMeshRenderers[mr].gameObject.layer))
                            skinnedMeshRenderers[mr].enabled = enabled;
                    }
                }
            }
