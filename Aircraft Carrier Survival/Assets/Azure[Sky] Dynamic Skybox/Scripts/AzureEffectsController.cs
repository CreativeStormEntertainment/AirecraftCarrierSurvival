    ...
    public class AzureEffectsController : MonoBehaviour
    {
        ...
        private void Update()
        {
            ...
            if (Application.isPlaying)
            {
                ...
                if (heavyRainEmitter != null)
                {
                    heavyRainEmitter.enabled = m_skyController.settings.HeavyRainSoundVolume > 0 || m_skyController.settings.MediumRainSoundVolume > 0 || m_skyController.settings.LightRainSoundVolume > 0;
                }
            }
        }
