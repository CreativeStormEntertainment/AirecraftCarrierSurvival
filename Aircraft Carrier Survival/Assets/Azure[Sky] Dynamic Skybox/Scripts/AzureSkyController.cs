...
namespace UnityEngine.AzureSky
{
    ...
    public class AzureSkyController : MonoBehaviour
    {
        ...
        private void Update()
        {
            ...
            Shader.SetGlobalVector(AzureShaderUniforms.DynamicCloudDirection, m_dynamicCloudDirection);
        ...
        public void UpdateSkySettings()
        {
            ...
            // Directions
            //Shader.SetGlobalVector(AzureShaderUniforms.SunDirection, -sunTransform.forward);
            //Shader.SetGlobalVector(AzureShaderUniforms.MoonDirection, -moonTransform.forward);
